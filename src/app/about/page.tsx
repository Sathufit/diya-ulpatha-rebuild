...
import { Heart, TreePine, Users, Globe, Leaf, Stethoscope, Award, Clock, Star } from "lucide-react";
              ...
              <div className="space-y-8 animate-on-scroll">
                ...
                <div className="bg-gradient-to-r from-accent/10 to-primary/10 p-6 rounded-2xl border-l-4 border-accent">
                  <p className="text-text-primary font-semibold italic text-lg">
                    &ldquo;Experience Ayurveda close to nature with our tailor-made wellness programs. 
                    It has been in the forefront to provide the best Ayurvedic treatment against 
                    a wide range of diseases.&rdquo;
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-accent/5 to-primary/5 rounded-3xl p-8 md:p-12 animate-on-scroll">
                <div className="space-y-6">
                  <p className="body-md text-text-secondary leading-relaxed">
                    Founded by a passionate nature lover and creative minded, 
                  ...
                  <div className="bg-white/50 rounded-2xl p-6 border-l-4 border-primary">
                    <p className="text-text-primary font-medium italic">
                      &ldquo;Every guest who walks through our doors embarks on a journey of transformation, 
                      discovering not just healing, but a deeper connection to themselves and the natural world.&rdquo;
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {whyChooseUs.map((reason, index) => (
                <div key={index} className={`card-feature animate-on-scroll animate-delay-${(index + 1) * 200}`}>
                  ...
                  <h3 className="text-xl font-bold text-text-primary mb-4">{reason.title}</h3>
        ...
        <div className="container mx-auto container-padding text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-primary-light mb-10 leading-relaxed">
              Experience the healing power of authentic Ayurveda in our peaceful sanctuary. 
              Your journey to wellness and self-discovery starts here.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
