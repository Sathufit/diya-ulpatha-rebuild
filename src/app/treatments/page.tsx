...
import { Heart, Shield, Leaf, Users, Star, Clock, CheckCircle } from "lucide-react";
        ...
        <div className="container mx-auto container-padding text-center relative z-10">
          <div className={`max-w-5xl mx-auto transition-all duration-1000 transform ${
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-text-primary mb-8">
              Ayurvedic <span className="gradient-text">Treatments</span>
            </h1>
            <p className="text-xl md:text-2xl text-text-muted max-w-4xl mx-auto leading-relaxed mb-12">
              Experience the healing power of ancient Ayurveda through our comprehensive range of 
              authentic treatments, each designed to restore balance and promote natural wellness.
            </p>
        ...
        <div className="container mx-auto container-padding">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-text-primary mb-6">
              Why Choose <span className="text-accent">Ayurvedic Healing?</span>
            </h2>
            <p className="text-xl text-text-muted max-w-3xl mx-auto">
              Discover the unique benefits of our time-tested approach to health and wellness
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-accent/10 to-primary/10 rounded-3xl p-8 md:p-12">
            <div className="text-center mb-8">
              <h3 className="text-3xl font-bold text-text-primary mb-4">
                Your <span className="text-accent">Healing Process</span>
              </h3>
              <p className="text-lg text-text-muted max-w-3xl mx-auto">
                Our systematic approach ensures you receive the most effective treatment for your unique needs
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h4 className="font-bold text-text-primary mb-2">Consultation</h4>
                <p className="text-text-muted text-sm">
                  Initial assessment with our qualified Ayurvedic doctor to understand your constitution
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-accent/20 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h4 className="font-bold text-text-primary mb-2">Personalized Plan</h4>
                <p className="text-text-muted text-sm">
                  Customized treatment plan designed specifically for your health needs and goals
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-accent/20 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h4 className="font-bold text-text-primary mb-2">Treatment</h4>
                <p className="text-text-muted text-sm">
                  Professional therapy sessions with experienced practitioners in a peaceful environment
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto container-padding text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-primary-light mb-10 leading-relaxed">
              Take the first step towards better health and wellness. Our experienced team 
              is here to guide you through authentic Ayurvedic healing.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/contact" className="btn-secondary text-lg px-8 py-4">
                Book Your Consultation
              </a>
              <a href="/accommodation" className="btn-outline text-lg px-8 py-4 text-white border-white hover:bg-white hover:text-primary">
                View Accommodation
              </a>
            </div>
          </div>
